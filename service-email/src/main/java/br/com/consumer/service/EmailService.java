...
import br.com.consumer.ConsumerEmail;
...
public class EmailService<T> implements Closeable {

    private final KafkaConsumer<String, T> consumer;

    private final ConsumerFunction parse;

    public EmailService(String groupId, String topic, ConsumerFunction parse, Class<T> type) {
        this(parse, groupId, type);
        consumer.subscribe(Collections.singletonList(topic));
    }

    public EmailService(String groupId, Pattern topic, ConsumerFunction parse, Class<T> type) {
        this(parse, groupId, type);
        consumer.subscribe(topic);
    }

    private EmailService(ConsumerFunction parse, String groupId, Class<T> type) {
        this.parse = parse;
